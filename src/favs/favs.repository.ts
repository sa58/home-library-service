...
export class FavsRepository {
    ...
    public deleteTrackFromFavs(uuid: string): void {
        let pos = FavsRepository.favs.tracks.findIndex(el => el.id === uuid);
    ...
    public deleteArtistFromFavs(uuid: string): void {
        let pos = FavsRepository.favs.artists.findIndex(el => el.id === uuid);
    ...
    public deleteAlbumFromFavs(uuid: string): void {
        let pos = FavsRepository.favs.albums.findIndex(el => el.id === uuid);
